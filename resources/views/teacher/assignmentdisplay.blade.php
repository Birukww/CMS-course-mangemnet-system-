...
@section('content')
<form  action="/assignmentdisplay" method="post">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="{{url('/assignmentdisplay')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
              ...
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="birthPlace">description</label>
              <div class="col-md-6">
                <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
              </div>
              <br>
              ...
              <div class="col-md-6">
                ...
                <br>
                <div class="form-group">
                <label class="col-md-3 control-label" for="dob">departement_id</label>
                <div class="col-md-6">
                  <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
                </div>
                <br>
