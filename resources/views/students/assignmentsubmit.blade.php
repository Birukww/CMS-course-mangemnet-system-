...
@section('content')
<form method="post" action="{{url('assignmentdisplay')}}">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <label class="col-md-3 control-label" for="birthPlace">name</label>
              <div class="col-md-6">
              ...
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="birthPlace">section</label>
              <div class="col-md-6">
                <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
              </div>
              <br>
              ...
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="birthPlace">assignment_id</label>
              <div class="col-md-6">
                <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
              </div>
              <br>
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="birthPlace">path</label>
              <div class="col-md-6">
                <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
              </div>
              <br>
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="birthPlace">user_id</label>
              <div class="col-md-6">
                <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
              </div>
              <br>
              <br>
                ...
                <div class="form-group">
                <label class="col-md-3 control-label" for="dob">instructor_id</label>
                <div class="col-md-6">
                  <input id="" name="" type="text" placeholder="" class="form-control" value=""></div>
                </div>
                <br>
